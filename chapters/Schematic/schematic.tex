...
\begin{figure}[H]
	\centering
	\includegraphics[width=16cm]{img/schematics/mainboard_power.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=16cm]{img/schematics/mainboard_fixed.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=16cm]{img/schematics/mainboard_NFC.jpg}
